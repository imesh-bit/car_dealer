...
import AddListingForm from "@/app/components/dashboard/add-listing/AddListingFormAutoPart";

export const metadata = {
  title: "Add Auto Part Listing || Voiture - Automotive & Car Dealer NextJS Template",
};

const AddAutoPartListing = () => {
  return (
              ...
              <div className="row">
                <div className="col-xl-8">
                  <div className="breadcrumb_content mb50">
                    <h2 className="breadcrumb_title">Add Auto Part Listing</h2>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="new_property_form">
                    <h4 className="title mb30">Upload New Auto Part Listing</h4>
                    <AddListingForm initialCategory="auto-part" />
                  </div>
                </div>
              </div>
            </div>
...
export default AddAutoPartListing;
