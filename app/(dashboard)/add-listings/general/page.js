...
import AddListingForm from "@/app/components/dashboard/add-listing/AddListingFormGeneral";

export const metadata = {
  title: "Add General Listing || Voiture - Automotive & Car Dealer NextJS Template",
};

const AddGeneralListing = () => {
  return (
              ...
              <div className="row">
                <div className="col-xl-8">
                  <div className="breadcrumb_content mb50">
                    <h2 className="breadcrumb_title">Add General Listing</h2>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="new_property_form">
                    <h4 className="title mb30">Upload New General Listing</h4>
                    <AddListingForm initialCategory="species" />
                  </div>
                </div>
              </div>
            </div>
...
export default AddGeneralListing;
